        ...
        {[
          ...
          <div key={f.label} style={{ background:"linear-gradient(135deg,rgba(255,255,255,0.9),rgba(248,245,240,0.95))", border:"1px solid rgba(212,160,23,0.2)", borderRadius:"16px", padding:"16px", display:"flex", flexDirection:"column", gap:"10px" }}>
            ...
            <div style={{ display:"flex", gap:"8px" }}>
              ...
              <button onClick={()=>f.set(f.val+1)} style={{ flex:1, padding:"10px", borderRadius:"10px", border:"1.5px solid rgba(200,144,10,0.5)", background:"linear-gradient(180deg, #7A6535 0%, #C4A030 25%, #DEC878 45%, #EDE5CE 50%, #DEC878 55%, #C4A030 75%, #7A6535 100%)", color:"#3D1800", fontSize:"18px", fontWeight:"900", cursor:"pointer" }}>+</button>
            </div>
  ...
  return (
    <div style={BG_STYLE}>
      ...
      <style>{`
        ...
        .continue-btn:not(:disabled):hover { background: linear-gradient(180deg, #8A7545 0%, #C4A030 25%, #DEC878 45%, #F5F0E0 50%, #DEC878 55%, #C4A030 75%, #8A7545 100%) !important; color: #1A0800 !important; box-shadow: 0 6px 22px rgba(200,144,10,0.5) !important; border-color: rgba(200,144,10,0.7) !important; transform: translateY(-1px); }
        .continue-btn:not(:disabled):active { background: linear-gradient(180deg, #5A4828 0%, #A07828 25%, #C8A850 45%, #E8E0C8 50%, #C8A850 55%, #A07828 75%, #5A4828 100%) !important; color: #1A0800 !important; box-shadow: 0 2px 8px rgba(200,144,10,0.4) !important; transform: scale(0.98); }
