        ...
        {[
          ...
          <div key={f.label} style={{ background:"linear-gradient(135deg,rgba(255,255,255,0.9),rgba(248,245,240,0.95))", border:"1px solid rgba(212,160,23,0.2)", borderRadius:"16px", padding:"16px", display:"flex", flexDirection:"column", gap:"10px" }}>
            ...
            <div style={{ display:"flex", gap:"8px" }}>
              ...
              <button onClick={()=>f.set(f.val+1)} style={{ flex:1, padding:"10px", borderRadius:"10px", border:"1.5px solid rgba(200,144,10,0.5)", background:"linear-gradient(180deg, #FFF0A0 0%, #F0C040 35%, #4E4840 50%, #F0C040 65%, #FFF0A0 100%)", color:"#3D1800", fontSize:"18px", fontWeight:"900", cursor:"pointer" }}>+</button>
            </div>
  ...
  return (
    <div style={BG_STYLE}>
      ...
      <style>{`
        ...
        .continue-btn:not(:disabled):hover { background: linear-gradient(180deg, #FFFAD0 0%, #F8D840 35%, #3E3830 50%, #F8D840 65%, #FFFAD0 100%) !important; color: #1A0800 !important; box-shadow: 0 6px 22px rgba(200,144,10,0.5) !important; border-color: rgba(200,144,10,0.7) !important; transform: translateY(-1px); }
        .continue-btn:not(:disabled):active { background: linear-gradient(180deg, #F0C040 0%, #D4A017 35%, #2C2416 50%, #D4A017 65%, #F0C040 100%) !important; color: #1A0800 !important; box-shadow: 0 2px 8px rgba(200,144,10,0.4) !important; transform: scale(0.98); }
