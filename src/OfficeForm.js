...
const CARD_STYLE = {
  ...
  backgroundImage: `
    ...
    radial-gradient(circle at 55% 8%, rgba(184,115,51,0.05) 0%, transparent 30%),
...
const inputSt = {
  ...
  border: "2px solid rgba(184,115,51,0.35)", background: "#F8F9FA",
  ...
  const renderStep2 = () => (
    <div className="fade-in-up">
      ...
      <div style={{ marginBottom:"30px" }}>
        ...
        {/* Running total box */}
        <div style={{ padding:"12px 16px", borderRadius:"12px", background:"linear-gradient(135deg,rgba(184,115,51,0.06),rgba(212,149,90,0.1))", border:"1px solid rgba(184,115,51,0.2)", marginBottom:"20px", textAlign:"center" }}>
    ...
    <div style={{ position:"fixed", top:0, left:0, right:0, bottom:0, background:"rgba(0,0,0,0.85)", display:"flex", alignItems:"center", justifyContent:"center", zIndex:9999, padding:"20px", overflowY:"auto" }}>
      <div style={{ background:"linear-gradient(135deg,#FFFFFF,#F5F0EB)", borderRadius:"24px", padding:"40px 35px", maxWidth:"700px", width:"100%", maxHeight:"90vh", overflowY:"auto", border:"1px solid rgba(184,115,51,0.25)", boxShadow:"0 30px 80px rgba(0,0,0,0.15)" }}>
        ...
        <div style={{ marginBottom:"30px" }}>
          ...
          <div style={{ display:"flex", alignItems:"center", gap:"12px", background:"rgba(184,115,51,0.06)", padding:"16px", borderRadius:"12px" }}>
