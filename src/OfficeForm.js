  ...
  const renderStep1 = () => (
    <div className="fade-in-up">
      ...
      <div style={{ display:"flex", gap:"15px" }}>
        ...
        <button onClick={goNext} disabled={!officeType} className="continue-btn" style={{ flex:2, padding:"18px", borderRadius:"16px", border: officeType?"1.5px solid rgba(62,56,48,0.4)":"1.5px solid rgba(62,56,48,0.15)", background: officeType?"linear-gradient(135deg, rgba(62,56,48,0.08), rgba(78,72,64,0.12))":"rgba(255,255,255,0.4)", fontSize:"15px", fontWeight:"800", cursor:officeType?"pointer":"not-allowed", color:officeType?"#3E3830":"#9A9490", display:"flex", alignItems:"center", justifyContent:"center", gap:"8px", transition:"all 0.25s ease", boxShadow:officeType?"0 2px 8px rgba(62,56,48,0.15)":"none" }}>
  ...
  const renderStep2 = () => (
    <div className="fade-in-up">
      ...
      <div style={{ display:"flex", gap:"15px" }}>
        ...
        <button onClick={goNext} disabled={!squareFeet||!frequency} className="continue-btn" style={{ flex:2, padding:"18px", borderRadius:"16px", border: (squareFeet&&frequency)?"1.5px solid rgba(62,56,48,0.4)":"1.5px solid rgba(62,56,48,0.15)", background: (squareFeet&&frequency)?"linear-gradient(135deg, rgba(62,56,48,0.08), rgba(78,72,64,0.12))":"rgba(255,255,255,0.4)", fontSize:"15px", fontWeight:"800", cursor:(squareFeet&&frequency)?"pointer":"not-allowed", color:(squareFeet&&frequency)?"#3E3830":"#9A9490", display:"flex", alignItems:"center", justifyContent:"center", gap:"8px", transition:"all 0.25s ease", boxShadow:(squareFeet&&frequency)?"0 2px 8px rgba(62,56,48,0.15)":"none" }}>
          Continue <ChevronRight size={20}/>
        </button>
      </div>
    </div>
  ...
  return (
    <div style={BG_STYLE}>
      ...
      <style>{`
        ...
        .continue-btn:not(:disabled):hover { background: linear-gradient(180deg, #C8B87A 0%, #EDE5CE 35%, #F5F0E0 50%, #EDE5CE 65%, #C8B87A 100%) !important; color: #3E3830 !important; box-shadow: 0 4px 14px rgba(62,56,48,0.2) !important; border-color: rgba(62,56,48,0.6) !important; transform: translateY(-1px); }
        .continue-btn:not(:disabled):active { background: linear-gradient(180deg, #B8A868 0%, #E8E0C8 35%, #F0ECD8 50%, #E8E0C8 65%, #B8A868 100%) !important; color: #3E3830 !important; box-shadow: 0 1px 4px rgba(62,56,48,0.2) !important; transform: scale(0.98); }
