            ...
            {step===3&&(
              <div className="fade-in-up">
                ...
                <div style={{marginBottom:"25px"}}>
                  <label style={{...labelSt,marginBottom:"12px"}}>📅 Expected Start Month</label>
                ...
                {/* Preferred Time */}
                <div style={{marginBottom:"25px"}}>
                  <label style={{...labelSt,marginBottom:"6px"}}>🕐 Preferred Service Times</label>
                  <p style={{fontSize:"12px",color:"#888",fontWeight:"600",marginBottom:"14px"}}>Add one or more time windows when cleaning is welcome.</p>
                  <div style={{display:"flex",gap:"10px",alignItems:"center",marginBottom:"12px",flexWrap:"wrap"}}>
                    <div style={{flex:1,minWidth:"110px"}}>
                      ...
                      <select value={timeFrom} onChange={e=>setTimeFrom(e.target.value)} style={{width:"100%",padding:"12px 10px",borderRadius:"12px",border:"2px solid rgba(212,160,23,0.35)",background:"#F8F9FA",color:"#4A3728",fontSize:"15px",fontWeight:"600",outline:"none",boxSizing:"border-box"}}>
                    ...
                    <div style={{flex:1,minWidth:"110px"}}>
                      ...
                      <select value={timeTo} onChange={e=>setTimeTo(e.target.value)} style={{width:"100%",padding:"12px 10px",borderRadius:"12px",border:"2px solid rgba(212,160,23,0.35)",background:"#F8F9FA",color:"#4A3728",fontSize:"15px",fontWeight:"600",outline:"none",boxSizing:"border-box"}}>
                        {["12:00 AM","12:30 AM","1:00 AM","1:30 AM","2:00 AM","2:30 AM","3:00 AM","3:30 AM","4:00 AM","4:30 AM","5:00 AM","5:30 AM","6:00 AM","6:30 AM","7:00 AM","7:30 AM","8:00 AM","8:30 AM","9:00 AM","9:30 AM","10:00 AM","10:30 AM","11:00 AM","11:30 AM","12:00 PM","12:30 PM","1:00 PM","1:30 PM","2:00 PM","2:30 PM","3:00 PM","3:30 PM","4:00 PM","4:30 PM","5:00 PM","5:30 PM","6:00 PM","6:30 PM","7:00 PM","7:30 PM","8:00 PM","8:30 PM","9:00 PM","9:30 PM","10:00 PM","10:30 PM","11:00 PM","11:30 PM"].map(t=><option key={t} value={t}>{t}</option>)}
                      </select>
                    </div>
                    <div style={{paddingTop:"22px"}}>
                      <button onClick={()=>{const w=`${timeFrom} – ${timeTo}`;if(!timeWindows.includes(w))setTimeWindows([...timeWindows,w]);}} style={{padding:"12px 16px",borderRadius:"12px",border:"2px solid rgba(212,160,23,0.5)",background:"linear-gradient(135deg,#D4A017,#F0C040)",color:"white",fontSize:"13px",fontWeight:"800",cursor:"pointer",whiteSpace:"nowrap"}}>+ Add</button>
                    </div>
                  </div>
